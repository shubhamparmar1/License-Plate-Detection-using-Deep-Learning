...
def plot_boxes(results, frame,classes):
    ...
    for i in range(n):
        row = cord[i]
        if row[4] >= 0.40: ### threshold value for detection. We are discarding everything below this value
...
# main(vid_path="pexels_videos.mp4",vid_out="vid_1.mp4") ### for custom video
# main(vid_path=0,vid_out="webcam_facemask_result.mp4") #### for webcam

main(img_path="car_group.png") ## for image
